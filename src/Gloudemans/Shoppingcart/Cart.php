...
class Cart
{
    ...
    protected function createRow($rowId, $id, $name, $qty, $price, $options)
    {
        ...
        if (!isset($cart->preloadModels[$this->associatedModelNamespace.'\\'.$this->associatedModel])) {
            $cart->preloadModels[$this->associatedModelNamespace.'\\'.$this->associatedModel] = [];
        }

        $cart->preloadModels[$this->associatedModelNamespace.'\\'.$this->associatedModel][$rowId] = $id;
